...
for (let i = 0; i < paragraphs.length; i++) {
	...
	switch (p.id) {
		...
		case "20": {
			p.innerHTML = tkb[date.getDay() + 1]?.[0]?.[1] || "."
			break
		}
		case "21": {
			p.innerHTML = tkb[date.getDay() + 1]?.[0]?.[2] || "."
			break
		}
		case "22": {
			p.innerHTML = tkb[date.getDay() + 1]?.[0]?.[3] || "."
			break
		}
		case "23": {
			p.innerHTML = tkb[date.getDay() + 1]?.[0]?.[4] || "."
			break
		}
		case "24": {
			p.innerHTML = tkb[date.getDay() + 1]?.[0]?.[5] || "."
			break
		}
		case "30": {
		...
		case "40": {
			p.innerHTML = tkb[date.getDay() + 1]?.[1]?.[1] || "."
			break
		}
		case "41": {
			p.innerHTML = tkb[date.getDay() + 1]?.[1]?.[2] || "."
			break
		}
		case "42": {
			p.innerHTML = tkb[date.getDay() + 1]?.[1]?.[3] || "."
			break
		}
		case "43": {
			p.innerHTML = tkb[date.getDay() + 1]?.[1]?.[4] || "."
			break
		}
		case "44": {
			p.innerHTML = tkb[date.getDay() + 1]?.[1]?.[5] || "."
			break
		}
		case "50": {
		...
		case "70": {
			p.innerHTML = tkb[date.getDay() + 2]?.[0]?.[1] || "."
			break
		}
		case "71": {
			p.innerHTML = tkb[date.getDay() + 2]?.[0]?.[2] || "."
			break
		}
		case "72": {
			p.innerHTML = tkb[date.getDay() + 2]?.[0]?.[3] || "."
			break
		}
		case "73": {
			p.innerHTML = tkb[date.getDay() + 2]?.[0]?.[4] || "."
			break
		}
		case "74": {
			p.innerHTML = tkb[date.getDay() + 2]?.[0]?.[5] || "."
			break
		}
		case "80": {
			const isOnline =
		...
		case "90": {
			p.innerHTML = tkb[date.getDay() + 2]?.[1]?.[1] || "."
			break
		}
		case "91": {
			p.innerHTML = tkb[date.getDay() + 2]?.[1]?.[2] || "."
			break
		}
		case "92": {
			p.innerHTML = tkb[date.getDay() + 2]?.[1]?.[3] || "."
			break
		}
		case "93": {
			p.innerHTML = tkb[date.getDay() + 2]?.[1]?.[4] || "."
			break
		}
		case "94": {
			p.innerHTML = tkb[date.getDay() + 2]?.[1]?.[5] || "."
			break
		}
	}
}
